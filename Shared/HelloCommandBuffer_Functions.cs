...
namespace Shared;
public unsafe partial class HelloCommandBuffer
{
    ...
    public void CmdDrawIndexedIndirectCount(Buffer buffer, ulong offset, Buffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
    {
        VK.CmdDrawIndexedIndirectCount(_commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
    }

    public void CmdDrawIndirectCount(Buffer buffer, ulong offset, Buffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride)
    {
    ...
    public void CmdCopyQueryPoolResults(QueryPool queryPool, uint firstQuery, uint queryCount, Buffer dstBuffer, ulong dstOffset, ulong stride, QueryResultFlags flags)
    {
    ...
    public void CmdUpdateBuffer(Buffer dstBuffer, ulong dstOffset, ulong dataSize, void* pData)
    {
    ...
    public void CmdClearDepthStencilImage(Image image, ImageLayout imageLayout, ClearDepthStencilValue* pDepthStencil, uint rangeCount,
    ...
    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, ulong* pOffsets, ulong* pSizes, ulong* pStrides)
    {
    ...
    public void CmdBlitImage(Image srcImage, ImageLayout srcImageLayout, Image dstImage, ImageLayout dstImageLayout, uint regionCount, ImageBlit* pRegions,
        Filter filter)
    {
    ...
    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, ulong* pOffsets, ulong* pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, ulong* pOffsets, in ulong pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, in pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, ulong* pOffsets, in ulong pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, in pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, in ulong pOffsets, ulong* pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, in pOffsets, pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, in ulong pOffsets, ulong* pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, in pOffsets, pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, in ulong pOffsets, in ulong pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, in pOffsets, in pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, Buffer* pBuffers, in ulong pOffsets, in ulong pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, pBuffers, in pOffsets, in pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, ulong* pOffsets, ulong* pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, pOffsets, pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, ulong* pOffsets, ulong* pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, pOffsets, pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, ulong* pOffsets, in ulong pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, pOffsets, in pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, ulong* pOffsets, in ulong pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, pOffsets, in pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, in ulong pOffsets, ulong* pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, in pOffsets, pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, in ulong pOffsets, ulong* pSizes, in ulong pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, in pOffsets, pSizes, in pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, in ulong pOffsets, in ulong pSizes, ulong* pStrides)
    {
        VK.CmdBindVertexBuffers2(_commandBuffer, firstBinding, bindingCount, in pBuffers, in pOffsets, in pSizes, pStrides);
    }

    public void CmdBindVertexBuffers2(uint firstBinding, uint bindingCount, in Buffer pBuffers, in ulong pOffsets, in ulong pSizes, in ulong pStrides)
    {
    ...
    public void CmdBindDescriptorSets(PipelineBindPoint pipelineBindPoint, PipelineLayout layout, uint firstSet, uint descriptorSetCount,
        DescriptorSet* pDescriptorSets, uint dynamicOffsetCount, in uint pDynamicOffsets)
    {
    ...
    public void CmdBindDescriptorSets(PipelineBindPoint pipelineBindPoint, PipelineLayout layout, uint firstSet, uint descriptorSetCount,
        in DescriptorSet pDescriptorSets, uint dynamicOffsetCount, uint* pDynamicOffsets)
    {
    ...
    public void CmdBindDescriptorSets(PipelineBindPoint pipelineBindPoint, PipelineLayout layout, uint firstSet, uint descriptorSetCount,
        in DescriptorSet pDescriptorSets, uint dynamicOffsetCount, in uint pDynamicOffsets)
    {
    ...
    public void CmdBindVertexBuffers(uint firstBinding, uint bindingCount, Buffer* pBuffers, in ulong pOffsets)
    {
        VK.CmdBindVertexBuffers(_commandBuffer, firstBinding, bindingCount, pBuffers, in pOffsets);
    }

    public void CmdBindVertexBuffers(uint firstBinding, uint bindingCount, in Buffer pBuffers, ulong* pOffsets)
    {
        VK.CmdBindVertexBuffers(_commandBuffer, firstBinding, bindingCount, in pBuffers, pOffsets);
    }

    public void CmdBindVertexBuffers(uint firstBinding, uint bindingCount, in Buffer pBuffers, in ulong pOffsets)
    {
        VK.CmdBindVertexBuffers(_commandBuffer, firstBinding, bindingCount, in pBuffers, in pOffsets);
    }

    public void CmdBlitImage(Image srcImage, ImageLayout srcImageLayout, Image dstImage, ImageLayout dstImageLayout, uint regionCount, in ImageBlit pRegions,
        Filter filter)
    {
    ...
    public void CmdClearColorImage(Image image, ImageLayout imageLayout, ClearColorValue* pColor, uint rangeCount, in ImageSubresourceRange pRanges)
    {
        VK.CmdClearColorImage(_commandBuffer, image, imageLayout, pColor, rangeCount, in pRanges);
    }

    public void CmdClearColorImage(Image image, ImageLayout imageLayout, in ClearColorValue pColor, uint rangeCount, ImageSubresourceRange* pRanges)
    {
        VK.CmdClearColorImage(_commandBuffer, image, imageLayout, in pColor, rangeCount, pRanges);
    }

    public void CmdClearColorImage(Image image, ImageLayout imageLayout, in ClearColorValue pColor, uint rangeCount, in ImageSubresourceRange pRanges)
    {
    ...
    public void CmdClearDepthStencilImage(Image image, ImageLayout imageLayout, in ClearDepthStencilValue pDepthStencil, uint rangeCount,
        ImageSubresourceRange* pRanges)
    {
    ...
    public void CmdCopyBuffer(Buffer srcBuffer, Buffer dstBuffer, uint regionCount, in BufferCopy pRegions)
    {
        VK.CmdCopyBuffer(_commandBuffer, srcBuffer, dstBuffer, regionCount, in pRegions);
    }

    public void CmdCopyBufferToImage(Buffer srcBuffer, Image dstImage, ImageLayout dstImageLayout, uint regionCount, in BufferImageCopy pRegions)
    {
        VK.CmdCopyBufferToImage(_commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount, in pRegions);
    }

    public void CmdCopyImage(Image srcImage, ImageLayout srcImageLayout, Image dstImage, ImageLayout dstImageLayout, uint regionCount, in ImageCopy pRegions)
    {
        VK.CmdCopyImage(_commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, in pRegions);
    }

    public void CmdCopyImageToBuffer(Image srcImage, ImageLayout srcImageLayout, Buffer dstBuffer, uint regionCount, in BufferImageCopy pRegions)
    {
    ...
    public void CmdResolveImage(Image srcImage, ImageLayout srcImageLayout, Image dstImage, ImageLayout dstImageLayout, uint regionCount, in ImageResolve pRegions)
    {
    ...
    public void CmdUpdateBuffer<T0>(Buffer dstBuffer, ulong dstOffset, ulong dataSize, ref T0 pData) where T0 : unmanaged
    {
