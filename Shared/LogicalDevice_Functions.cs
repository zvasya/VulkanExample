...
public partial class LogicalDevice
{
    ...
    public unsafe void GetDeviceQueue2(DeviceQueueInfo2* pQueueInfo, Queue* pQueue)
    {
    ...
    public unsafe void DestroyBuffer(Buffer buffer, AllocationCallbacks* pAllocator)
    {
    ...
    public unsafe void DestroyCommandPool(CommandPool commandPool, AllocationCallbacks* pAllocator)
    {
        VK.DestroyCommandPool(_device, commandPool, pAllocator);
    }

    public unsafe void DestroyDescriptorPool(DescriptorPool descriptorPool, AllocationCallbacks* pAllocator)
    {
        VK.DestroyDescriptorPool(_device, descriptorPool, pAllocator);
    }

    public unsafe void DestroyDescriptorSetLayout(DescriptorSetLayout descriptorSetLayout, AllocationCallbacks* pAllocator)
    {
    ...
    public unsafe void DestroyFence(Fence fence, AllocationCallbacks* pAllocator)
    {
        VK.DestroyFence(_device, fence, pAllocator);
    }

    public unsafe void DestroyFramebuffer(Framebuffer framebuffer, AllocationCallbacks* pAllocator)
    {
        VK.DestroyFramebuffer(_device, framebuffer, pAllocator);
    }

    public unsafe void DestroyImage(Image image, AllocationCallbacks* pAllocator)
    {
        VK.DestroyImage(_device, image, pAllocator);
    }

    public unsafe void DestroyImageView(ImageView imageView, AllocationCallbacks* pAllocator)
    {
        VK.DestroyImageView(_device, imageView, pAllocator);
    }

    public unsafe void DestroyPipeline(Pipeline pipeline, AllocationCallbacks* pAllocator)
    {
    ...
    public unsafe void DestroyRenderPass(RenderPass renderPass, AllocationCallbacks* pAllocator)
    {
        VK.DestroyRenderPass(_device, renderPass, pAllocator);
    }

    public unsafe void DestroySampler(Sampler sampler, AllocationCallbacks* pAllocator)
    {
    ...
    public unsafe void GetBufferMemoryRequirements(Buffer buffer, MemoryRequirements* pMemoryRequirements)
    {
    ...
    public unsafe void GetImageMemoryRequirements(Image image, MemoryRequirements* pMemoryRequirements)
    {
        VK.GetImageMemoryRequirements(_device, image, pMemoryRequirements);
    }

    public unsafe void GetRenderAreaGranularity(RenderPass renderPass, Extent2D* pGranularity)
    {
    ...
    public unsafe void UpdateDescriptorSetWithTemplate(DescriptorSet descriptorSet, DescriptorUpdateTemplate descriptorUpdateTemplate, void* pData)
    {
        VK.UpdateDescriptorSetWithTemplate(_device, descriptorSet, descriptorUpdateTemplate, pData);
    }

    public unsafe void FreeCommandBuffers(CommandPool commandPool, uint commandBufferCount, CommandBuffer* pCommandBuffers)
    {
        VK.FreeCommandBuffers(_device, commandPool, commandBufferCount, pCommandBuffers);
    }

    public unsafe void GetDeviceQueue(uint queueFamilyIndex, uint queueIndex, Queue* pQueue)
    {
        VK.GetDeviceQueue(_device, queueFamilyIndex, queueIndex, pQueue);
    }

    public unsafe void GetImageSparseMemoryRequirements(Image image, uint* pSparseMemoryRequirementCount, SparseImageMemoryRequirements* pSparseMemoryRequirements)
    {
        VK.GetImageSparseMemoryRequirements(_device, image, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
    }

    public unsafe void GetImageSubresourceLayout(Image image, ImageSubresource* pSubresource, SubresourceLayout* pLayout)
    {
    ...
    public unsafe void GetDeviceQueue2(DeviceQueueInfo2* pQueueInfo, out Queue pQueue)
    {
        VK.GetDeviceQueue2(_device, pQueueInfo, out pQueue);
    }

    public unsafe void GetDeviceQueue2(in DeviceQueueInfo2 pQueueInfo, Queue* pQueue)
    {
        VK.GetDeviceQueue2(_device, in pQueueInfo, pQueue);
    }

    public void GetDeviceQueue2(in DeviceQueueInfo2 pQueueInfo, out Queue pQueue)
    {
    ...
    public void UpdateDescriptorSetWithTemplate<T0>(DescriptorSet descriptorSet, DescriptorUpdateTemplate descriptorUpdateTemplate, ref T0 pData) where T0 : unmanaged
    {
        VK.UpdateDescriptorSetWithTemplate(_device, descriptorSet, descriptorUpdateTemplate, ref pData);
    }

    public void DestroyBuffer(Buffer buffer, in AllocationCallbacks pAllocator)
    {
    ...
    public void DestroyCommandPool(CommandPool commandPool, in AllocationCallbacks pAllocator)
    {
        VK.DestroyCommandPool(_device, commandPool, in pAllocator);
    }

    public void DestroyDescriptorPool(DescriptorPool descriptorPool, in AllocationCallbacks pAllocator)
    {
        VK.DestroyDescriptorPool(_device, descriptorPool, in pAllocator);
    }

    public void DestroyDescriptorSetLayout(DescriptorSetLayout descriptorSetLayout, in AllocationCallbacks pAllocator)
    {
    ...
    public void DestroyFence(Fence fence, in AllocationCallbacks pAllocator)
    {
        VK.DestroyFence(_device, fence, in pAllocator);
    }

    public void DestroyFramebuffer(Framebuffer framebuffer, in AllocationCallbacks pAllocator)
    {
        VK.DestroyFramebuffer(_device, framebuffer, in pAllocator);
    }

    public void DestroyImage(Image image, in AllocationCallbacks pAllocator)
    {
        VK.DestroyImage(_device, image, in pAllocator);
    }

    public void DestroyImageView(ImageView imageView, in AllocationCallbacks pAllocator)
    {
        VK.DestroyImageView(_device, imageView, in pAllocator);
    }

    public void DestroyPipeline(Pipeline pipeline, in AllocationCallbacks pAllocator)
    {
    ...
    public void DestroyRenderPass(RenderPass renderPass, in AllocationCallbacks pAllocator)
    {
        VK.DestroyRenderPass(_device, renderPass, in pAllocator);
    }

    public void DestroySampler(Sampler sampler, in AllocationCallbacks pAllocator)
    {
    ...
    public void FreeCommandBuffers(CommandPool commandPool, uint commandBufferCount, in CommandBuffer pCommandBuffers)
    {
    ...
    public unsafe void GetImageSparseMemoryRequirements(Image image, uint* pSparseMemoryRequirementCount, out SparseImageMemoryRequirements pSparseMemoryRequirements)
    {
        VK.GetImageSparseMemoryRequirements(_device, image, pSparseMemoryRequirementCount, out pSparseMemoryRequirements);
    }

    public unsafe void GetImageSparseMemoryRequirements(Image image, ref uint pSparseMemoryRequirementCount, SparseImageMemoryRequirements* pSparseMemoryRequirements)
    {
        VK.GetImageSparseMemoryRequirements(_device, image, ref pSparseMemoryRequirementCount, pSparseMemoryRequirements);
    }

    public void GetImageSparseMemoryRequirements(Image image, ref uint pSparseMemoryRequirementCount, out SparseImageMemoryRequirements pSparseMemoryRequirements)
    {
        VK.GetImageSparseMemoryRequirements(_device, image, ref pSparseMemoryRequirementCount, out pSparseMemoryRequirements);
    }

    public unsafe void GetImageSubresourceLayout(Image image, ImageSubresource* pSubresource, out SubresourceLayout pLayout)
    {
        VK.GetImageSubresourceLayout(_device, image, pSubresource, out pLayout);
    }

    public unsafe void GetImageSubresourceLayout(Image image, in ImageSubresource pSubresource, SubresourceLayout* pLayout)
    {
        VK.GetImageSubresourceLayout(_device, image, in pSubresource, pLayout);
    }

    public void GetImageSubresourceLayout(Image image, in ImageSubresource pSubresource, out SubresourceLayout pLayout)
    {
    ...
    public unsafe Result CreateRenderPass2(RenderPassCreateInfo2* pCreateInfo, AllocationCallbacks* pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass2(_device, pCreateInfo, pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass2(RenderPassCreateInfo2* pCreateInfo, AllocationCallbacks* pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass2(_device, pCreateInfo, pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass2(RenderPassCreateInfo2* pCreateInfo, in AllocationCallbacks pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass2(_device, pCreateInfo, in pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass2(RenderPassCreateInfo2* pCreateInfo, in AllocationCallbacks pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass2(_device, pCreateInfo, in pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass2(in RenderPassCreateInfo2 pCreateInfo, AllocationCallbacks* pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass2(_device, in pCreateInfo, pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass2(in RenderPassCreateInfo2 pCreateInfo, AllocationCallbacks* pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass2(_device, in pCreateInfo, pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass2(in RenderPassCreateInfo2 pCreateInfo, in AllocationCallbacks pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass2(_device, in pCreateInfo, in pAllocator, pRenderPass);
    }

    public Result CreateRenderPass2(in RenderPassCreateInfo2 pCreateInfo, in AllocationCallbacks pAllocator, out RenderPass pRenderPass)
    {
    ...
    public unsafe Result AllocateCommandBuffers(CommandBufferAllocateInfo* pAllocateInfo, CommandBuffer* pCommandBuffers)
    {
        return VK.AllocateCommandBuffers(_device, pAllocateInfo, pCommandBuffers);
    }

    public unsafe Result AllocateCommandBuffers(CommandBufferAllocateInfo* pAllocateInfo, out CommandBuffer pCommandBuffers)
    {
        return VK.AllocateCommandBuffers(_device, pAllocateInfo, out pCommandBuffers);
    }

    public unsafe Result AllocateCommandBuffers(in CommandBufferAllocateInfo pAllocateInfo, CommandBuffer* pCommandBuffers)
    {
        return VK.AllocateCommandBuffers(_device, in pAllocateInfo, pCommandBuffers);
    }

    public Result AllocateCommandBuffers(in CommandBufferAllocateInfo pAllocateInfo, out CommandBuffer pCommandBuffers)
    {
        return VK.AllocateCommandBuffers(_device, in pAllocateInfo, out pCommandBuffers);
    }

    public unsafe Result AllocateDescriptorSets(DescriptorSetAllocateInfo* pAllocateInfo, DescriptorSet* pDescriptorSets)
    {
        return VK.AllocateDescriptorSets(_device, pAllocateInfo, pDescriptorSets);
    }

    public unsafe Result AllocateDescriptorSets(DescriptorSetAllocateInfo* pAllocateInfo, out DescriptorSet pDescriptorSets)
    {
        return VK.AllocateDescriptorSets(_device, pAllocateInfo, out pDescriptorSets);
    }

    public unsafe Result AllocateDescriptorSets(in DescriptorSetAllocateInfo pAllocateInfo, DescriptorSet* pDescriptorSets)
    {
        return VK.AllocateDescriptorSets(_device, in pAllocateInfo, pDescriptorSets);
    }

    public Result AllocateDescriptorSets(in DescriptorSetAllocateInfo pAllocateInfo, out DescriptorSet pDescriptorSets)
    {
    ...
    public unsafe Result CreateBuffer(BufferCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, Buffer* pBuffer)
    {
        return VK.CreateBuffer(_device, pCreateInfo, pAllocator, pBuffer);
    }

    public unsafe Result CreateBuffer(BufferCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out Buffer pBuffer)
    {
        return VK.CreateBuffer(_device, pCreateInfo, pAllocator, out pBuffer);
    }

    public unsafe Result CreateBuffer(BufferCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, Buffer* pBuffer)
    {
        return VK.CreateBuffer(_device, pCreateInfo, in pAllocator, pBuffer);
    }

    public unsafe Result CreateBuffer(BufferCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out Buffer pBuffer)
    {
        return VK.CreateBuffer(_device, pCreateInfo, in pAllocator, out pBuffer);
    }

    public unsafe Result CreateBuffer(in BufferCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, Buffer* pBuffer)
    {
        return VK.CreateBuffer(_device, in pCreateInfo, pAllocator, pBuffer);
    }

    public unsafe Result CreateBuffer(in BufferCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out Buffer pBuffer)
    {
        return VK.CreateBuffer(_device, in pCreateInfo, pAllocator, out pBuffer);
    }

    public unsafe Result CreateBuffer(in BufferCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, Buffer* pBuffer)
    {
        return VK.CreateBuffer(_device, in pCreateInfo, in pAllocator, pBuffer);
    }

    public Result CreateBuffer(in BufferCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out Buffer pBuffer)
    {
    ...
    public unsafe Result CreateCommandPool(CommandPoolCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, CommandPool* pCommandPool)
    {
        return VK.CreateCommandPool(_device, pCreateInfo, pAllocator, pCommandPool);
    }

    public unsafe Result CreateCommandPool(CommandPoolCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out CommandPool pCommandPool)
    {
        return VK.CreateCommandPool(_device, pCreateInfo, pAllocator, out pCommandPool);
    }

    public unsafe Result CreateCommandPool(CommandPoolCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, CommandPool* pCommandPool)
    {
        return VK.CreateCommandPool(_device, pCreateInfo, in pAllocator, pCommandPool);
    }

    public unsafe Result CreateCommandPool(CommandPoolCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out CommandPool pCommandPool)
    {
        return VK.CreateCommandPool(_device, pCreateInfo, in pAllocator, out pCommandPool);
    }

    public unsafe Result CreateCommandPool(in CommandPoolCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, CommandPool* pCommandPool)
    {
        return VK.CreateCommandPool(_device, in pCreateInfo, pAllocator, pCommandPool);
    }

    public unsafe Result CreateCommandPool(in CommandPoolCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out CommandPool pCommandPool)
    {
        return VK.CreateCommandPool(_device, in pCreateInfo, pAllocator, out pCommandPool);
    }

    public unsafe Result CreateCommandPool(in CommandPoolCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, CommandPool* pCommandPool)
    {
        return VK.CreateCommandPool(_device, in pCreateInfo, in pAllocator, pCommandPool);
    }

    public Result CreateCommandPool(in CommandPoolCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out CommandPool pCommandPool)
    {
        return VK.CreateCommandPool(_device, in pCreateInfo, in pAllocator, out pCommandPool);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, ComputePipelineCreateInfo* pCreateInfos, AllocationCallbacks* pAllocator, Pipeline* pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, ComputePipelineCreateInfo* pCreateInfos, AllocationCallbacks* pAllocator, out Pipeline pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, out pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, ComputePipelineCreateInfo* pCreateInfos, in AllocationCallbacks pAllocator, Pipeline* pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, pCreateInfos, in pAllocator, pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, ComputePipelineCreateInfo* pCreateInfos, in AllocationCallbacks pAllocator, out Pipeline pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, pCreateInfos, in pAllocator, out pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, in ComputePipelineCreateInfo pCreateInfos, AllocationCallbacks* pAllocator, Pipeline* pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, in pCreateInfos, pAllocator, pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, in ComputePipelineCreateInfo pCreateInfos, AllocationCallbacks* pAllocator, out Pipeline pPipelines)
    {
        return VK.CreateComputePipelines(_device, pipelineCache, createInfoCount, in pCreateInfos, pAllocator, out pPipelines);
    }

    public unsafe Result CreateComputePipelines(PipelineCache pipelineCache, uint createInfoCount, in ComputePipelineCreateInfo pCreateInfos, in AllocationCallbacks pAllocator, Pipeline* pPipelines)
    {
    ...
    public unsafe Result CreateDescriptorPool(DescriptorPoolCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, DescriptorPool* pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, pCreateInfo, pAllocator, pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(DescriptorPoolCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out DescriptorPool pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, pCreateInfo, pAllocator, out pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(DescriptorPoolCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, DescriptorPool* pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, pCreateInfo, in pAllocator, pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(DescriptorPoolCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out DescriptorPool pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, pCreateInfo, in pAllocator, out pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(in DescriptorPoolCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, DescriptorPool* pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, in pCreateInfo, pAllocator, pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(in DescriptorPoolCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out DescriptorPool pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, in pCreateInfo, pAllocator, out pDescriptorPool);
    }

    public unsafe Result CreateDescriptorPool(in DescriptorPoolCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, DescriptorPool* pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, in pCreateInfo, in pAllocator, pDescriptorPool);
    }

    public Result CreateDescriptorPool(in DescriptorPoolCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out DescriptorPool pDescriptorPool)
    {
        return VK.CreateDescriptorPool(_device, in pCreateInfo, in pAllocator, out pDescriptorPool);
    }

    public unsafe Result CreateDescriptorSetLayout(DescriptorSetLayoutCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, DescriptorSetLayout* pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, pCreateInfo, pAllocator, pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(DescriptorSetLayoutCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out DescriptorSetLayout pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, pCreateInfo, pAllocator, out pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(DescriptorSetLayoutCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, DescriptorSetLayout* pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, pCreateInfo, in pAllocator, pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(DescriptorSetLayoutCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out DescriptorSetLayout pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, pCreateInfo, in pAllocator, out pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(in DescriptorSetLayoutCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, DescriptorSetLayout* pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, in pCreateInfo, pAllocator, pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(in DescriptorSetLayoutCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out DescriptorSetLayout pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, in pCreateInfo, pAllocator, out pSetLayout);
    }

    public unsafe Result CreateDescriptorSetLayout(in DescriptorSetLayoutCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, DescriptorSetLayout* pSetLayout)
    {
        return VK.CreateDescriptorSetLayout(_device, in pCreateInfo, in pAllocator, pSetLayout);
    }

    public Result CreateDescriptorSetLayout(in DescriptorSetLayoutCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out DescriptorSetLayout pSetLayout)
    {
    ...
    public unsafe Result CreateFence(FenceCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, Fence* pFence)
    {
        return VK.CreateFence(_device, pCreateInfo, pAllocator, pFence);
    }

    public unsafe Result CreateFence(FenceCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out Fence pFence)
    {
        return VK.CreateFence(_device, pCreateInfo, pAllocator, out pFence);
    }

    public unsafe Result CreateFence(FenceCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, Fence* pFence)
    {
        return VK.CreateFence(_device, pCreateInfo, in pAllocator, pFence);
    }

    public unsafe Result CreateFence(FenceCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out Fence pFence)
    {
        return VK.CreateFence(_device, pCreateInfo, in pAllocator, out pFence);
    }

    public unsafe Result CreateFence(in FenceCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, Fence* pFence)
    {
        return VK.CreateFence(_device, in pCreateInfo, pAllocator, pFence);
    }

    public unsafe Result CreateFence(in FenceCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out Fence pFence)
    {
        return VK.CreateFence(_device, in pCreateInfo, pAllocator, out pFence);
    }

    public unsafe Result CreateFence(in FenceCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, Fence* pFence)
    {
        return VK.CreateFence(_device, in pCreateInfo, in pAllocator, pFence);
    }

    public Result CreateFence(in FenceCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out Fence pFence)
    {
        return VK.CreateFence(_device, in pCreateInfo, in pAllocator, out pFence);
    }

    public unsafe Result CreateFramebuffer(FramebufferCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, Framebuffer* pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, pCreateInfo, pAllocator, pFramebuffer);
    }

    public unsafe void CreateFramebuffer(FramebufferCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out Framebuffer pFramebuffer)
    {
        Helpers.CheckErrors(VK.CreateFramebuffer(_device, pCreateInfo, pAllocator, out pFramebuffer));
    }

    public unsafe Result CreateFramebuffer(FramebufferCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, Framebuffer* pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, pCreateInfo, in pAllocator, pFramebuffer);
    }

    public unsafe Result CreateFramebuffer(FramebufferCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out Framebuffer pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, pCreateInfo, in pAllocator, out pFramebuffer);
    }

    public unsafe Result CreateFramebuffer(in FramebufferCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, Framebuffer* pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, in pCreateInfo, pAllocator, pFramebuffer);
    }

    public unsafe Result CreateFramebuffer(in FramebufferCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out Framebuffer pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, in pCreateInfo, pAllocator, out pFramebuffer);
    }

    public unsafe Result CreateFramebuffer(in FramebufferCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, Framebuffer* pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, in pCreateInfo, in pAllocator, pFramebuffer);
    }

    public Result CreateFramebuffer(in FramebufferCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out Framebuffer pFramebuffer)
    {
        return VK.CreateFramebuffer(_device, in pCreateInfo, in pAllocator, out pFramebuffer);
    }

    public unsafe Result CreateGraphicsPipelines(PipelineCache pipelineCache, uint createInfoCount, GraphicsPipelineCreateInfo* pCreateInfos, AllocationCallbacks* pAllocator, Pipeline* pPipelines)
    {
        return VK.CreateGraphicsPipelines(_device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    }

    public unsafe Result CreateGraphicsPipelines(PipelineCache pipelineCache, uint createInfoCount, GraphicsPipelineCreateInfo* pCreateInfos, AllocationCallbacks* pAllocator, out Pipeline pPipelines)
    {
        return VK.CreateGraphicsPipelines(_device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, out pPipelines);
    }

    public unsafe Result CreateGraphicsPipelines(PipelineCache pipelineCache, uint createInfoCount, GraphicsPipelineCreateInfo* pCreateInfos, in AllocationCallbacks pAllocator, Pipeline* pPipelines)
    {
    ...
    public unsafe Result CreateGraphicsPipelines(PipelineCache pipelineCache, uint createInfoCount, in GraphicsPipelineCreateInfo pCreateInfos, AllocationCallbacks* pAllocator, Pipeline* pPipelines)
    {
    ...
    public unsafe Result CreateGraphicsPipelines(PipelineCache pipelineCache, uint createInfoCount, in GraphicsPipelineCreateInfo pCreateInfos, in AllocationCallbacks pAllocator, Pipeline* pPipelines)
    {
    ...
    public unsafe Result CreateImage(ImageCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, Image* pImage)
    {
        return VK.CreateImage(_device, pCreateInfo, pAllocator, pImage);
    }

    public unsafe Result CreateImage(ImageCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out Image pImage)
    {
        return VK.CreateImage(_device, pCreateInfo, pAllocator, out pImage);
    }

    public unsafe Result CreateImage(ImageCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, Image* pImage)
    {
        return VK.CreateImage(_device, pCreateInfo, in pAllocator, pImage);
    }

    public unsafe Result CreateImage(ImageCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out Image pImage)
    {
        return VK.CreateImage(_device, pCreateInfo, in pAllocator, out pImage);
    }

    public unsafe Result CreateImage(in ImageCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, Image* pImage)
    {
        return VK.CreateImage(_device, in pCreateInfo, pAllocator, pImage);
    }

    public unsafe Result CreateImage(in ImageCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out Image pImage)
    {
        return VK.CreateImage(_device, in pCreateInfo, pAllocator, out pImage);
    }

    public unsafe Result CreateImage(in ImageCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, Image* pImage)
    {
        return VK.CreateImage(_device, in pCreateInfo, in pAllocator, pImage);
    }

    public Result CreateImage(in ImageCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out Image pImage)
    {
        return VK.CreateImage(_device, in pCreateInfo, in pAllocator, out pImage);
    }

    public unsafe Result CreateImageView(ImageViewCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, ImageView* pView)
    {
        return VK.CreateImageView(_device, pCreateInfo, pAllocator, pView);
    }

    public unsafe Result CreateImageView(ImageViewCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out ImageView pView)
    {
        return VK.CreateImageView(_device, pCreateInfo, pAllocator, out pView);
    }

    public unsafe Result CreateImageView(ImageViewCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, ImageView* pView)
    {
        return VK.CreateImageView(_device, pCreateInfo, in pAllocator, pView);
    }

    public unsafe Result CreateImageView(ImageViewCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out ImageView pView)
    {
        return VK.CreateImageView(_device, pCreateInfo, in pAllocator, out pView);
    }

    public unsafe Result CreateImageView(in ImageViewCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, ImageView* pView)
    {
        return VK.CreateImageView(_device, in pCreateInfo, pAllocator, pView);
    }

    public unsafe Result CreateImageView(in ImageViewCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out ImageView pView)
    {
        return VK.CreateImageView(_device, in pCreateInfo, pAllocator, out pView);
    }

    public unsafe Result CreateImageView(in ImageViewCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, ImageView* pView)
    {
        return VK.CreateImageView(_device, in pCreateInfo, in pAllocator, pView);
    }

    public Result CreateImageView(in ImageViewCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out ImageView pView)
    {
    ...
    public unsafe Result CreateRenderPass(RenderPassCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass(_device, pCreateInfo, pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass(RenderPassCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass(_device, pCreateInfo, pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass(RenderPassCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass(_device, pCreateInfo, in pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass(RenderPassCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass(_device, pCreateInfo, in pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass(in RenderPassCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass(_device, in pCreateInfo, pAllocator, pRenderPass);
    }

    public unsafe Result CreateRenderPass(in RenderPassCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass(_device, in pCreateInfo, pAllocator, out pRenderPass);
    }

    public unsafe Result CreateRenderPass(in RenderPassCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, RenderPass* pRenderPass)
    {
        return VK.CreateRenderPass(_device, in pCreateInfo, in pAllocator, pRenderPass);
    }

    public Result CreateRenderPass(in RenderPassCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out RenderPass pRenderPass)
    {
        return VK.CreateRenderPass(_device, in pCreateInfo, in pAllocator, out pRenderPass);
    }

    public unsafe Result CreateSampler(SamplerCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, Sampler* pSampler)
    {
        return VK.CreateSampler(_device, pCreateInfo, pAllocator, pSampler);
    }

    public unsafe Result CreateSampler(SamplerCreateInfo* pCreateInfo, AllocationCallbacks* pAllocator, out Sampler pSampler)
    {
        return VK.CreateSampler(_device, pCreateInfo, pAllocator, out pSampler);
    }

    public unsafe Result CreateSampler(SamplerCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, Sampler* pSampler)
    {
        return VK.CreateSampler(_device, pCreateInfo, in pAllocator, pSampler);
    }

    public unsafe Result CreateSampler(SamplerCreateInfo* pCreateInfo, in AllocationCallbacks pAllocator, out Sampler pSampler)
    {
        return VK.CreateSampler(_device, pCreateInfo, in pAllocator, out pSampler);
    }

    public unsafe Result CreateSampler(in SamplerCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, Sampler* pSampler)
    {
        return VK.CreateSampler(_device, in pCreateInfo, pAllocator, pSampler);
    }

    public unsafe Result CreateSampler(in SamplerCreateInfo pCreateInfo, AllocationCallbacks* pAllocator, out Sampler pSampler)
    {
        return VK.CreateSampler(_device, in pCreateInfo, pAllocator, out pSampler);
    }

    public unsafe Result CreateSampler(in SamplerCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, Sampler* pSampler)
    {
        return VK.CreateSampler(_device, in pCreateInfo, in pAllocator, pSampler);
    }

    public Result CreateSampler(in SamplerCreateInfo pCreateInfo, in AllocationCallbacks pAllocator, out Sampler pSampler)
    {
    ...
    public unsafe Result FreeDescriptorSets(DescriptorPool descriptorPool, uint descriptorSetCount, DescriptorSet* pDescriptorSets)
    {
    ...
    public unsafe Result ResetFences(uint fenceCount, Fence* pFences)
    {
        return VK.ResetFences(_device, fenceCount, pFences);
    }

    public Result ResetFences(uint fenceCount, in Fence pFences)
    {
        return VK.ResetFences(_device, fenceCount, in pFences);
    }

    public unsafe Result WaitForFences(uint fenceCount, Fence* pFences, Bool32 waitAll, ulong timeout)
    {
        return VK.WaitForFences(_device, fenceCount, pFences, waitAll, timeout);
    }

    public Result WaitForFences(uint fenceCount, in Fence pFences, Bool32 waitAll, ulong timeout)
    {
